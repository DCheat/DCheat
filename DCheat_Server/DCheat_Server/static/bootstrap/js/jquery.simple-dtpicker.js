...
/**
gitId : astroluj 
added Init .datepicker class change visibility : visible
ESC keyUp allhide pickers
**/
	...
	**/
	...
	var draw = function($picker, option, year, month, day, hour, min) {
		...
		if (isCloseButton) {
			...
			$link_close.addClass('inconClose'); 
	...
	var hidePicker = function (event) {
		if(event.target != '[object HTMLInputElement]')ActivePickerId = -1;
	...
	var allHidePicker = function (event) {
		var KEYCODE_ESC = 27 ;
